						...
						<div className="col-xl-8 mb-15">	
							...
							<div className="slider-item">
									<div className="feature-container feature-bx2 feature1">
										...
										<div className="icon-content">
											<h2 className="ttr-title">Category-1</h2>
								...
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature1">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Elder Care Companions</h3>
											<p>Find compassionate and caring,</p>
								...
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Nursing Care</h3>
											<p>Certified and trained nurses for short</p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature3">
										...
										<div className="icon-content">
											...
											<p>Physiotherapy services at home </p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature1">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Doctor Consitations</h3>
											<p>Get online consultation from qualified and experienced doctors including physicians,</p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Medical Equipment on Rent</h3>
											<p>Get all types of medical equipment delivered ,</p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">ICU Setup at Home</h3>
											<p>Customized Intensive Care Unit setups available for a varied range of health issues </p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Lab Tests at Home</h3>
											<p>Now book from a range of diagnostic tests </p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Care Packages</h3>
											<p>Remote care packages for providing </p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
							...
							<div className="slider-item">
									<div className="feature-container feature-bx2 feature1">
										...
										<div className="icon-content">
											<h2 className="ttr-title">Category-2</h2>
								...
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Patient Care Assistant</h3>
											<p>Deliverables</p>
											<p>Personal Hygienic care </p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Basic Care</h3>
											<h4>Deliverables</h4>
											<h5> PCA + Deliverables</h5>
								...
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Advanced Care</h3>
											<h4>Deliverables</h4>
											<h5>  Basic + Deliverables</h5>
											<p>Insertion and management of Ryles tube IV Cannula foley's catheter</p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Speciality Care</h3>
											<h4>Deliverables</h4>
											<h5>  Advanced + Deliverables</h5>
											<p>Tracheostomy care</p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Elder/Geriatric Care</h3>
											<h4>Deliverables</h4>
											{/* <h5>  Advanced + Deliverables</h5> */}
											<p> Health checks at Lakshmi Mission Hospitals</p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Critical Care</h3>
											<h4>Deliverables</h4>
											<h5> Speciality Care + Deliverables</h5>
											<p> Health checks at Lakshmi Mission Hospitals</p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								...
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Mother & Baby Care / Nanny Care</h3>
											<h4>Deliverables</h4>
											{/* <h5> Speciality Care + Deliverables</h5> */}
											<p>Identifies common postnatal sickness</p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
							...
							<div className="slider-item">
									<div className="feature-container feature-bx2 feature1">
										...
										<div className="icon-content">
											<h2 className="ttr-title">Category-3</h2>
								...
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature1">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Personal Care</h3>
											<p>Oral Hygiene, Bed Bath/Sponge Bath, </p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Nutrition</h3>
											<p>Timely medication and monitoring,</p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature3">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Toileting</h3>
											<p>Assist to bathroom or bedside commode,</p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature1">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Mobility</h3>
											<p>Assist with walking and home exercises,</p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Support Services</h3>
											<p>Patient's laundry, </p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
								</div>
								<div className="slider-item">
									<div className="feature-container feature-bx2 feature2">
										...
										<div className="icon-content">
											<h3 className="ttr-title">Condition Specific Care</h3>
											<p>Dementia,</p>
											<Link to="/service-detail" className="btn btn-primary light">View More</Link>
										</div>
									</div>
